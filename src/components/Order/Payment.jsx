...
export default function Payment() {
    ...
    let [] = useState();
    // let [tabSelected,setTabSelected] = useState();
    // let myTabs = useRef([]);
...
// const tabSelect = (index) => {setTabSelected(index)};
            ...
            <div className="container-fluid pt-5 bg-light spacer my-5">
                <div className="">
                    <div className="mb-5 d-flex gap-3">
                        <button href="#" className="tabnonselected tabselected" id="day1Btn" onClick="">
                            <h3 className="day fw-bolder fs-4 lh-lg">Detail</h3>
                        </button>
                        <button href="#" className="tabnonselected" id="day2Btn" onClick="">
                            <h3 className="day fw-bolder fs-4 lh-lg">Warranty</h3>
                        </button>
                        <button href="#" className="tabnonselected" id="day3Btn" onClick="">
